-- XTREME REACTION DATABASE MIGRATION
-- Execute these sections one by one in the Supabase SQL Editor
-- URL: https://supabase.com/dashboard/project/xhcfjhzfyozzuicubqmh/sql
